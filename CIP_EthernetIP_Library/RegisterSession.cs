//	<copyright file="RegisterSession.cs"  company="Alliant Technologies">
//		Copyright © 2024 Alliant Technologies, LLC. All rights reserved.
//	</copyright>
//	<summary>
//		Class file for RegisterSession.
//	</summary>
namespace CIP_EthernetIP_Library
{
    /// <summary>
    /// The <see cref="RegisterSession"/> class represents the RegisterSession request and reply data.
    /// </summary>
    /// <seealso cref="CIP_EthernetIP_Library.MessageBase" />
    internal sealed class RegisterSession : MessageBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterSession"/> class.
        /// </summary>
        ...
        /// <exception cref="InvalidDataException">Thrown when the provided length, in bytes, of data is too small to possibly represent <see cref="RegisterSession"/>.</exception>
        public override void Deserialize(byte[] buffer, int startingOffset, int length)
        {
            ...
            {
                throw new InvalidDataException(String.Format(Properties.Resources.BufferTooSmallInvalidDataException, nameof(buffer), nameof(RegisterSession), this.DataSize));
            }

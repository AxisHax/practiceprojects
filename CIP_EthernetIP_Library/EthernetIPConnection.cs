...
namespace CIP_EthernetIP_Library
{
    ...
    internal sealed class EthernetIPConnection
    {
        ...
        /// </summary>
        /// <param name="host">The device to connect to.</param>
        public void Connect(string host)
        {
            // Connect to the server and register the session.
            this.client.Connect(host, TcpPortNumber);

            this.RegisterSession();

            // Calling method like this to test it.
            #pragma warning disable SendRRDataTest00
            this.SendRRDataTest();
            #pragma warning restore SendRRDataTest00
        }
        ...
        /// <summary>
        /// Method to test and see the SendRRData structure.
        /// TODO: Change method to send proper data to the server.
        /// </summary>
        [Experimental("SendRRDataTest00")]
        private void SendRRDataTest()
        {
            byte[] routePath =
            {
                0x15, 0x0F, 0x31, 0x33, 0x30, 0x2E,
                0x31, 0x35, 0x31, 0x2E, 0x31, 0x33,
                0x37, 0x2E, 0x31, 0x30, 0x35
            };
            ...
            SendRRData sessionData = new SendRRData(routePath, paddedEpath);
            Header header = new Header()
            {
            ...
            byte[] csdBytes = sessionData.Serialize();
        }
    }
}

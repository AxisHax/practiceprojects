...
namespace CIP_EthernetIP_Library
{
    ...
    {
        /// <summary>Gets the size, in bytes, of the data.</summary>
        ...
        /// <summary>Serializes a child class of <see cref="MessageBase"/> by calling its own implementation of <see cref="Serialize()"/>.</summary>
        /// <param name="messageObject">The message. A child of <see cref="MessageBase"/>.</param>
        /// <returns>A byte array containing the contents of the message object.</returns>
        protected static byte[] Serialize(MessageBase messageObject)
        {
        ...
        /// <summary>Serializes a child class of <see cref="MessageBase"/> by calling its own implementation of <see cref="Deserialize(byte[], int, int)()"/>.</summary>
        /// <param name="messageObject">The message object. A child of <see cref="MessageBase"/>.</param>
        ...
        protected static void Deserialize(MessageBase messageObject, byte[] buffer, int startingOffset, int length)
        {
            messageObject.Deserialize(buffer, startingOffset, length);
        }
        ...
        protected static void Deserialize<T>(ref T value, byte[] buffer, ref int offset) where T : Enum
        {
            ...
            {
                value = (T)Enum.ToObject(value.GetType(), BitConverter.ToInt16(buffer, offset));
                offset += sizeof(short);
            }
